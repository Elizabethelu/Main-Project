...
<body>
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="bg-light text-center p-5 wow fadeIn" data-wow-delay="0.5s">
                        <h1>Register Here</h1>
                        <form action="boat_regaction.php" method="POST" enctype="multipart/form-data">
                            <div class="row g-3">
                                 <div class="col-12 col-sm-6">
                                    licence Id:
                                    <input type="text" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 6 or more characters"  name="id_number" class="form-control border-0" placeholder="Your Registration Number" style="height: 55px;">
                                    </div>
                                <div class="col-12 col-sm-6">
                                   
                                    Name:
                                    <input type="text" onkeypress="return (event.charCode > 64 && 
    event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"  name="name" class="form-control border-0" placeholder="Name" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    Email:
                                ...
                                <div class="col-12 col-sm-6">
                                    Phone:
                                    <input type="text" pattern="[6-9]{1}[0-9]{9}" name="phone" class="form-control border-0" placeholder="Your Mobile" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    Address:
    ...
    function AadharValidate() {
        ...
        if (aadhar != '') {
            if (aadhar.match(adharcardTwelveDigit)) {
                ...
                return false;
                                ...
                                <!-- <div class="col-12 col-sm-6">
                                    Starting place:
                                    <input type="text" name="startingplace" class="form-control border-0" placeholder="Starting Place" style="height: 55px;">
                                </div> -->
                                
    
                                <div class="col-12 col-sm-6">
                                    ID proof:
                                    <input type="file" name="image1" class="form-control border-0" placeholder="" style="height: 55px;">
                                </div>
                               <div class="col-12 col-sm-6">
                                    Category :
                               ...
                               <!--  <div class="col-12 col-sm-6">
                                    Price Rs:
                                    <input type="number" name="price" class="form-control border-0" placeholder="Enter price" style="height: 55px;">
                                </div> -->
                                 <div class="col-12 col-sm-6">
                                    District:
       ...
       <option value="Wayanad">Wayanad</option>
                                ...
                                <div class="col-12 col-sm-6">
                                    Password:
                                    <input  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" type="text" name="password" class="form-control border-0" placeholder="Your Password" style="height: 55px;">
                                </div>
                                <div class="col-12">
