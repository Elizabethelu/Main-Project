...
<body>
    ...
    <tr style="background-color: skyblue;">
       <th>Image</th><th>Name</th> <th>Phone</th><th>Address</th><th>District</th><th>Place</th><th>Action</th>
    </tr>
       ...
       <?php
          ...
          include '../config.php';
              ...
              $query="SELECT * FROM  boat b, login l where b.login_id = l.login_id and l.status='notapproved' and l.type = 'Boat'";
