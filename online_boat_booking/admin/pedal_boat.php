                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h1 class="text-white text-uppercase mb-3 animated slideInDown">PEDAL BOAT PANEL</h1>
    ...
    <div class="container-xxl py-5">
     ...
     <?php
          ...
          include '../config.php';
              ...
              $query="SELECT * FROM  pedal_boat where status2='null'";
       ...
       ?>
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item p-4">
                       ...
                       <a class="btn-slide mt-2" href="pedal_boat_approvel_action.php?boat_id=<?php echo $data['pedal_boat_id'];?>"><i class="fa fa-arrow-right"></i><span>Approve</span></a>
                        <a class="btn-slide mt-2" href="pedal_boatboat_reject_action.php?boat_id=<?php echo $data['pedal_boat_id'];?>"><i class="fa fa-arrow-right"></i><span>Reject</span></a>
                    </div>
                </div>
                 <?php
              }
