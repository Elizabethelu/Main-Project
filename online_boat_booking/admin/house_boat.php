    ...
    <div class="container-xxl py-5">
        <div class="container py-5">
          ...
          include '../config.php';
              ...
              $query="SELECT * FROM  house_boat where status2='null'";
       ...
       ?>
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item p-4">
                        ...
                        <a class="btn-slide mt-2" href="house_boat_approvel_action.php?boat_id=<?php echo $data['house_boat_id'];?>"><i class="fa fa-arrow-right"></i><span>Approve</span></a>
                        <a class="btn-slide mt-2" href="house_boatboat_reject_action.php?boat_id=<?php echo $data['house_boat_id'];?>"><i class="fa fa-arrow-right"></i><span>Reject</span></a>
                    </div>
                </div>
                 <?php
              }
