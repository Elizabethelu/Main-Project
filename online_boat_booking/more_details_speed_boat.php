                               ...
                               <div class="col-12 col-sm-6">
                                ...
                                Other Boat Details:
                                 ...
                                 <div class="col-12">
                                   ...
                                   <!--  <a href="house_boat_booking_details.php?id=<?php echo $data['house_boat_id'];?>&&owner_id=<?php echo $data['owner_id'];?>" class="btn btn-primary w-100 py-3" type="submit">book now</a> -->
