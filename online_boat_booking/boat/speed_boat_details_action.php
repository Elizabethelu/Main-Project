...
if ($category=='Speed Boat.')
   {

	$row="INSERT INTO `speed_boat` (`boat_name`, `starting_place`, `ending_place`, `price`, `other_details`, `seats`, `image1`, `image2`, `image3`, `owner_id`, `status2`, `status`) VALUES ('$boat_name', '$Starting_place', '$Ending_place', '$Price', '$Other_details', '$Seats', '$file_name1', '$file_name2', '$file_name3', '$Owner_id', 'null', 'waiting for approvel');";
