    ...
    <div class="container-xxl py-5">
        <div class="container py-5">
          ...
          include '../config.php';
              ...
              $query="SELECT * FROM  pedal_boat b, login l where b.owner_id = l.login_id and l.status='approved' and l.type = 'Boat' and l.login_id=$sid and b.status='waiting for approvel' and pedal_boat_id=$id";
