    ...
    <div class="container-xxl py-5">
     ...
     <?php
          ...
          include '../config.php';
              ...
              $query="SELECT * FROM  pedal_boat where status2='approved' ";
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item p-4">
                        ...
                        <a class="btn-slide mt-2" href="more_details_pedal_boat.php?boat_id=<?php echo $data['pedal_boat_id'];?>"><i class="fa fa-arrow-right"></i><span>View  More Details</span></a>
                         <a class="btn-slide mt-2" href="check_pedal_bookings.php?boat_id=<?php echo $data['pedal_boat_id'];?>"><i class="fa fa-arrow-right"></i><span>Check Available Date</span></a>
                    </div>
                </div>
                 <?php
              }
