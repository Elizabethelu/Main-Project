            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="bg-light text-center p-5 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <form action="pedal_boat_booking_action.php" method="POST" enctype="multipart/form-data" >
                            <div class="row g-3">
                                 <?php
         include '../config.php';
         $id = $_SESSION['log_id'];
...
$("#txtenddate").datepicker({});
       ...
       ?>
                             <input type="hidden" value="<?php echo $data['pedal_boat_id'];?>" name="boat_id" class="form-control border-0" placeholder="food price" style="height: 55px;" required="">
                             ...
                             <input type="hidden" value="Pedal Boat" name="boatName" class="form-control border-0" placeholder="food price" style="height: 55px;" required="">
