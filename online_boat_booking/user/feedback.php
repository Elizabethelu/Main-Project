                        ...
                        <form action="feedback_action.php" method="POST">
                            <div class="row g-3">
                                  <div style="padding-right: 900px;" class="col-12">
                                    ...
                                    <input style="width: 300px;border-radius: 2px;" type="text" name="feedback">
                                </div>
    ...
    <tr style="background-color: skyblue;">
       ...
       <?php
          ...
          include '../config.php';
              ...
              $query="SELECT * FROM  feedback where status='approved' and user_id=$id ";
       ...
       ?>
          ...
          <tr style="color: black;">
           ...
           <td> <?php echo $data['feedback'];?></td>
            ...
            <td><a style="color: red;" class="btn btn-success" href="feedback_remove.php?id=<?php echo $data['feedback_id'];?>">Reject</a></td>
