    ...
    event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"  name="name" class="form-control border-0" placeholder="<?php echo $data['boat_name'];?>" style="height: 55px;" required="" >
                              ...
                              <!--  <div class="col-12 col-sm-6">
                                ...
                                Other Boat Details:
                                 ...
                                 <div class="col-12">
                                    <a href="speed_boat_booking_details.php?id=<?php echo $data['speed_boat_id'];?>&&owner_id=<?php echo $data['owner_id'];?>" class="btn btn-primary w-100 py-3" type="submit">book now</a>
                                </div>
                        </form>
                    </div>
                </div>
