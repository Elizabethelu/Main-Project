    ...
    <div class="container-xxl py-5">
        <div class="container py-5">
          ...
          include '../config.php';
              ...
              $query="SELECT * FROM  speed_boat where status2 ='approved' ";
       ...
       ?>
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item p-4">
                        ...
                        <a class="btn-slide mt-2" href="check_speed_bookings.php?boat_id=<?php echo $data['speed_boat_id'];?>"><i class="fa fa-arrow-right"></i><span>Check Available Date</span></a>
                    </div>
                </div>
                 <?php
              }
